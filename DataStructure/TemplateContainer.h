...
public:
	...
	*/
	...
	private:
		...
		TemplateContainer* pContainer;	// iterator 가 가리킬 데이터를 관리하는 컨테이너 주소
	...
	public:
		...
		friend class TemplateContainer; // 친구선언. outer class 에서 inner class 의 private 멤버도 접근할수 있는 사이.
		// 원래는 많이 사용하지 않는것이 안좋다. 애초에 private 는 접근제한 할려고 하는 접근제어지시자인데.
		// 멤버함수를 통해서 접근하는것이 좋다.
		// 하지만 이경우 TemplateContainer 와 inner class 는 긴밀한 관계이기 때문에 이렇게 접근을 허용하도록 해준다.
